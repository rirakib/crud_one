...
<body class="bg-light">
    ...
    <h1 class="text-center bg-dark text-center pt-3 pb-3 text-white">Create Profile</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card bg-dark text-white p-3">
                    <form action="{{route('worker.index')}}" method="POST">
                        @csrf
                        <div class="form-group mt-2">
                            <label for="userNumber">User id</label>
                            <input type="number" class="form-control @error('userNumber') is-invalid @enderror" id="userNumber" name="userNumber"
